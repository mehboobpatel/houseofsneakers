...
# git clone https://github.com/mehboobpatel/houseofsneakers
```

+ Open terminal on your workspace with

FIRST ENTER SERVER FOLDER


```
cd /home/houseofsneakers/server
run npm install
run npm start
```
SECOND ENTER CLIENT FOLDER


```
cd /home/houseofsneakers/client
run npm install
run npm start
